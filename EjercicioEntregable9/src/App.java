public class App {
    public static void main(String[] args) throws Exception {
        ...
        Administrativos administrativos1 = new Administrativos("163657552", "Javier", "San Martin 1158", 2020, "Administrativo","Completa");
        ...
        System.out.println("\n");
        Repartidores repartidores1 = new Repartidores("253855214", "Hernan", "Colon 15", 2021, "Repartidor", 12);
        System.out.println("El sueldo del repartidor " + repartidores1.getNombre() +" es de $ " + repartidores1.calcularSueldoMensual());
    
        System.out.println("\n");
        Vendedores sueldovendedor1 = new Vendedores("123654852", "Pedro", "las Heras 452", 2012, "Vendedor", 63000);
        Empleado sueldoAdmistrativo1 = new Administrativos("32654852", "Lorena Paez", "Reconquista 15",2018, "Administrativo", "media jornada");
        Repartidores suelRepartidores = new Repartidores("14235121", "Martin Lopez", "San Martin 436", 2014,"Repartidor", 10);
