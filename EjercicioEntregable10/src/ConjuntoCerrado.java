public class ConjuntoCerrado extends Vivienda {
    ...
    public ConjuntoCerrado(int id, double valorM2, double tamanioM2, String direccion, float valorAdministracion, boolean incluyeAreasComunes, float valorEnM2, Integer numeroHabitaciones, Integer numeroBanios) {
